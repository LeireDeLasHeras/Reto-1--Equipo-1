...
<div class="main-content">
    <div class="content-left-vistaPregunta">
        ...
        if($dataToView["data"]["pregunta"]["idUsuario"] == $_SESSION['user_data']['idUsuario'] || $_SESSION['user_data']['tipo'] == 'admin'): ?>
            <button class="eliminar" onclick="window.location.href='index.php?controller=pregunta&action=delete&id=<?php echo $dataToView["data"]["pregunta"]["idPregunta"]; ?>'">
        ...
        <a class="bookmark" href="#" id-data="<?php echo $dataToView["data"]["pregunta"]["idPregunta"]; ?>" isSaved="<?php echo $dataToView["data"]["isSaved"] ? 'true' : 'false'; ?>" controller-data="pregunta">
        ...
        <a class="boton-like" href="#" id-data="<?php echo $dataToView["data"]["pregunta"]["idPregunta"]; ?>" isLiked="<?php echo $dataToView["data"]["isLiked"] ? 'true' : 'false'; ?>" controller-data="pregunta">
                ...
                <?php foreach($dataToView["data"]["respuestas"] as $respuesta): ?>
                    <p>
                        ...
                        if($respuesta["idUsuario"] == $_SESSION['user_data']['idUsuario'] || $_SESSION['user_data']['tipo'] == 'admin' || $respuesta["idUsuario"] == $_SESSION['user_data']['idUsuario']): ?>
                            <button class="eliminar" onclick="window.location.href='index.php?controller=respuesta&action=delete&idRespuesta=<?php echo $respuesta["idRespuesta"]; ?>&idPregunta=<?php echo $dataToView["data"]["pregunta"]["idPregunta"]; ?>'">
                                <img class="eliminar-img" src="assets/img/logo_borrar.png" alt="Icono Borrar">
                                <img class="eliminar-img-hover" src="assets/img/logo_borrar_rojo.png" alt="Icono Borrar">
                            </button>
                        <?php endif; ?> 
                        ...
                        <a class="bookmark" href="#" id-data="<?php echo $respuesta["idRespuesta"]; ?>" isSaved="<?php echo $respuestaGuardada ? 'true' : 'false'; ?>" controller-data="respuesta">
                            <img src="assets/img/logo_guardar_<?php echo $respuestaGuardada ? 'r' : 'l'; ?>.png" alt="Icono Bookmark guardado">
                        </a>

                        <a class="boton-like" href="#" id-data="<?php echo $respuesta["idRespuesta"]; ?>" isLiked="<?php echo $respuestaFavorita ? 'true' : 'false'; ?>" controller-data="respuesta">
